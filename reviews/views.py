...
class ReviewViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsAuthenticated]  # sharx yozish un tizimga kirgan bolishi kere

    def get_queryset(self):
        # ommaviy foydalanuvchi faqat tasdiqlangan sharhni koradi, admin hammasini koradi
